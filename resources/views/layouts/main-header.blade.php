                ...
                <li class="nav-item dropdown ">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
                        <div class="dropdown-header notifications">
                            <strong>@lang('site.sidebar.languages')</strong>
                            <span class="badge badge-pill badge-warning">{{count(LaravelLocalization::getSupportedLocales())}}</span>
                        </div>

                            <div class="dropdown-divider"></div>
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)

                                    <a class="dropdown-item" style="{{App::getLocale() == $localeCode ? "color: #16181b;text-decoration: none;background-color: #f8f9fa;" : ''}}" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                        {{ $properties['native'] }}
                ...
                <li class="nav-item dropdown mr-30">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="#"
                            onclick="console.log('hellow');event.preventDefault(); document.getElementById('logout').submit()"
                       >
