...
@section('title')
    @lang("site.teacher.edit_teacher")
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        ...
                                        <div class='input-group date'>
                                            <input class="form-control" type="text"  id="datepicker-action" name="joined_date" data-date-format="yyyy-mm-dd" value="{{$teacher->joined_date}}" required>
                                        </div>
                                        @error('joined_date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class='input-group date'>
                                            <input class="form-control" type="text" name="phone" value="{{$teacher->phone}}" required>
                                        </div>
                                        @error('phone')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
